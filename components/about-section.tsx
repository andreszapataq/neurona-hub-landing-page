        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          >
            <div className="relative overflow-hidden rounded-2xl border border-border bg-card p-1">
              <div className="rounded-xl bg-gradient-to-br from-primary/10 via-secondary to-card p-12">
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <motion.div
                      ...
                      className="flex flex-col items-center justify-center rounded-xl border border-border/50 bg-background/50 p-6 text-center backdrop-blur-sm"
                    >
